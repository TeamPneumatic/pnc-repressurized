...
public class GuiUVLightBox extends GuiPneumaticContainerBase{
    private static final ResourceLocation guiTexture = new ResourceLocation(Textures.GUI_UV_LIGHT_BOX);
    private final TileEntityUVLightBox te;
    ...
    public GuiUVLightBox(InventoryPlayer player, TileEntityUVLightBox teLightBox){

        super(new ContainerUVLightBox(player, teLightBox));
        ySize = 176;
        te = teLightBox;
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y){
        ...
        switch(te.redstoneMode){
            case 0:
                ...
                break;
            case 1:
                redstoneButton.displayString = "Chance > 70%";
                break;
            case 2:
                redstoneButton.displayString = "Chance > 80%";
                break;
            case 3:
                redstoneButton.displayString = "Chance > 90%";
                break;
            case 4:
                redstoneButton.displayString = "Chance = 100%";
                break;
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y){
        ...
        GuiUtils.drawPressureGauge(fontRendererObj, -1, PneumaticValues.MAX_PRESSURE_UV_LIGHTBOX, PneumaticValues.DANGER_PRESSURE_UV_LIGHTBOX, PneumaticValues.MIN_PRESSURE_UV_LIGHTBOX, te.getPressure(ForgeDirection.UNKNOWN), xStart + xSize * 3 / 4, yStart + ySize * 1 / 4 + 4, zLevel);
    ...
    private List<String> getPressureStats(){
        ...
        pressureStatText.add("\u00a70" + (double)Math.round(PneumaticValues.VOLUME_UV_LIGHTBOX) + " mL.");
        float pressureLeft = te.volume - PneumaticValues.VOLUME_UV_LIGHTBOX;
        if(pressureLeft > 0) {
    ...
    protected void actionPerformed(GuiButton button){
        switch(button.id){
            case 0:// redstone button
                if(redstoneBehaviourStat != null) redstoneBehaviourStat.closeWindow();//verify this works.
                break;
        }
