...
import pneumaticCraft.client.model.ModelPneumaticCilinder;
...
public class RenderItemPneumaticCilinder implements IItemRenderer{

    private final ModelPneumaticCilinder model;

    public RenderItemPneumaticCilinder(){
        model = new ModelPneumaticCilinder();
    }
