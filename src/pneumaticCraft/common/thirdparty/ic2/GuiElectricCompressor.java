...
public class GuiElectricCompressor extends GuiPneumaticContainerBase{
    ...
    public GuiElectricCompressor(InventoryPlayer player, TileEntityElectricCompressor te){
        ...
        super(new ContainerElectricCompressor(player, te));
        ySize = 176;
        this.te = te;
    ...
    public void initGui(){
        ...
        inputStat = new GuiAnimatedStat(this, "Input", IC2Items.getItem("glassFiberCableItem"), xStart + xSize, 3, 0xFF555555, pressureStat, false);
        ...
        infoStat.setText(GuiConstants.INFO_ELECTRIC_COMPRESSOR);
        upgradeStat.setText(GuiConstants.UPGRADES_ELECTRIC_COMPRESSOR);
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y){
        ...
        GuiUtils.drawPressureGauge(fontRendererObj, -1, PneumaticValues.MAX_PRESSURE_ELECTRIC_COMPRESSOR, PneumaticValues.DANGER_PRESSURE_ELECTRIC_COMPRESSOR, -1, te.getPressure(ForgeDirection.UNKNOWN), xStart + xSize * 3 / 4, yStart + ySize * 1 / 4 + 4, zLevel);
    ...
    private List<String> getPressureStats(){
        ...
        pressureStatText.add("\u00a70" + (double)Math.round(PneumaticValues.VOLUME_ELECTRIC_COMPRESSOR) + " mL.");
        float pressureLeft = te.volume - PneumaticValues.VOLUME_ELECTRIC_COMPRESSOR;
        if(pressureLeft > 0) {
