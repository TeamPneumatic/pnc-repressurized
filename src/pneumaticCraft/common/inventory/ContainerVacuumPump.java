...
public class ContainerVacuumPump extends Container{
    TileEntityVacuumPump te;

    public ContainerVacuumPump(InventoryPlayer inventoryPlayer, TileEntityVacuumPump teVacuumPump){
        te = teVacuumPump;
        te.openGUI();
        ...
        for(int i = 0; i < 2; i++) {
            for(int j = 0; j < 2; j++) {
                addSlotToContainer(new SlotUpgrade(teVacuumPump, i * 2 + j, 71 + j * 18, 29 + i * 18));
            }
        }
