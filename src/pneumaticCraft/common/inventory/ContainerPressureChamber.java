...
public class ContainerPressureChamber extends Container{
    TileEntityPressureChamberValve te;

    public ContainerPressureChamber(InventoryPlayer inventoryPlayer, TileEntityPressureChamberValve teValve){
        te = teValve;
        te.openGUI();

        // add the upgrade slots
        addSlotToContainer(new SlotUpgrade(teValve, 0, 48, 29));
        addSlotToContainer(new SlotUpgrade(teValve, 1, 66, 29));
        addSlotToContainer(new SlotUpgrade(teValve, 2, 48, 47));
        addSlotToContainer(new SlotUpgrade(teValve, 3, 66, 47));
