...
public class Textures {
    ...
    public static final ResourceLocation PROG_WIDGET_CONDITION_ENERGY = new ResourceLocation(PROG_WIDGET_LOCATION + "condition_rf_piece.png");
    ...
    public static final ResourceLocation GUI_PROBLEMS_TEXTURE = guiTexture("gui_problem.png");
    ...
    public static final ResourceLocation GUI_UNDO_ICON_LOCATION = guiTexture("gui_undo_icon.png");
    public static final ResourceLocation GUI_REDO_ICON_LOCATION = guiTexture("gui_redo.png");
    public static final ResourceLocation GUI_COPY_ICON_LOCATION = guiTexture("gui_copy.png");
    ...
    public static final ResourceLocation GUI_PLASTIC_MIXER = guiTexture("gui_plastic_mixer.png");
