...
public class RenderUniversalSensor extends TileEntityRenderer<TileEntityUniversalSensor> {
    ...
    public RenderUniversalSensor(TileEntityRendererDispatcher dispatcher) {
        ...
        dish4 = new ModelRenderer(32, 32, 10, 50);
    ...
    @Override
    public void render(TileEntityUniversalSensor te, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
