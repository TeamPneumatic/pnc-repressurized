...
public class MinigunUpgradeScreen extends AbstractUpgradeManagerScreen {
    public MinigunUpgradeScreen(ChargingStationUpgradeManagerMenu container, Inventory inv, Component displayString) {
