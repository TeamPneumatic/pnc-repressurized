...
public class JackhammerUpgradeScreen extends AbstractUpgradeManagerScreen {
    public JackhammerUpgradeScreen(ChargingStationUpgradeManagerMenu container, Inventory inv, Component displayString) {
