...
public class ProgWidgetHarvestScreen extends ProgWidgetDigAndPlaceScreen<ProgWidgetHarvest> {

    public ProgWidgetHarvestScreen(ProgWidgetHarvest widget, ProgrammerScreen guiProgrammer){
