...
public class AdvancedLiquidCompressorScreen extends LiquidCompressorScreen {
    private WidgetTemperature tempWidget;

    public AdvancedLiquidCompressorScreen(LiquidCompressorMenu container, Inventory inv, Component displayString) {
    ...
    public void containerTick() {
        ...
        tempWidget.setTemperature(((AdvancedLiquidCompressorBlockEntity) te).getHeatExchanger().getTemperatureAsInt());
