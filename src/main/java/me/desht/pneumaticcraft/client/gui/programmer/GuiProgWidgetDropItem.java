...
public class GuiProgWidgetDropItem extends GuiProgWidgetImportExport<ProgWidgetDropItem> {
    ...
    public void init() {
        ...
        WidgetRadioButton radioButton = new WidgetRadioButton(guiLeft + 8, guiTop + 82, 0xFF404040,
                I18n.format("pneumaticcraft.gui.progWidget.drop.dropMethod.random"), b -> progWidget.setDropStraight(false));
        ...
        WidgetRadioButton radioButton2 = new WidgetRadioButton(guiLeft + 8, guiTop + 94, 0xFF404040,
                I18n.format("pneumaticcraft.gui.progWidget.drop.dropMethod.straight"), b -> progWidget.setDropStraight(true));
        ...
        WidgetCheckBox pickupDelay = new WidgetCheckBox(guiLeft + 8, guiTop + 115, 0xFF404040,
                I18n.format("pneumaticcraft.gui.progWidget.drop.hasPickupDelay"), b -> progWidget.setPickupDelay(b.checked));
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawString(TextFormatting.UNDERLINE + I18n.format("pneumaticcraft.gui.progWidget.drop.dropMethod"), guiLeft + 8, guiTop + 70, 0xFF404060);
    }
}
