...
public class GuiProgWidgetGoToLocation<T extends ProgWidgetGoToLocation> extends GuiProgWidgetAreaShow<T> {
    ...
    public void init() {
        ...
        WidgetRadioButton radioButton = new WidgetRadioButton(guiLeft + 8, guiTop + 24, 0xFF404040,
                I18n.format("pneumaticcraft.gui.progWidget.goto.doneWhenDeparting"),b -> progWidget.doneWhenDeparting = false);
        radioButton.checked = !progWidget.doneWhenDeparting;
        radioButton.setTooltip(PneumaticCraftUtils.splitString(I18n.format("pneumaticcraft.gui.progWidget.goto.doneWhenDeparting.tooltip")));
        addButton(radioButton);
        radioButtons.add(radioButton);
        radioButton.otherChoices = radioButtons;

        WidgetRadioButton radioButton2 = new WidgetRadioButton(guiLeft + 8, guiTop + 38, 0xFF404040,
                I18n.format("pneumaticcraft.gui.progWidget.goto.doneWhenArrived"), b -> progWidget.doneWhenDeparting = true);
        radioButton2.checked = progWidget.doneWhenDeparting;
        radioButton2.setTooltip(PneumaticCraftUtils.splitString(I18n.format("pneumaticcraft.gui.progWidget.goto.doneWhenArrived.tooltip")));
