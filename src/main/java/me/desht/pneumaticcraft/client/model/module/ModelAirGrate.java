...
public class ModelAirGrate extends AbstractModelRenderer<ModuleAirGrate> {
    ...
    public ModelAirGrate() {
        ...
        base3 = new ModelRenderer(128, 128, 0, 0);
