...
public class ModelAirCannon extends AbstractTileModelRenderer.BaseModel {
    private final RendererModel baseTurn;
    private final RendererModel baseFrame1;
    private final RendererModel baseFrame2;
    private final RendererModel baseFrame3;
    private final RendererModel baseFrame4;
    private final RendererModel baseFrame5;
    private final RendererModel baseFrame6;
    private final RendererModel cannon1;
    private final RendererModel cannon2;
    private final RendererModel cannon3;
    private final RendererModel cannon4;
    private final RendererModel cannon5;

    public ModelAirCannon() {
        baseTurn = new RendererModel(this, 36, 7);
        ...
        baseFrame1 = new RendererModel(this, 10, 7);
        ...
        baseFrame2 = new RendererModel(this, 10, 7);
        ...
        baseFrame3 = new RendererModel(this, 18, 13);
        ...
        baseFrame4 = new RendererModel(this, 18, 13);
        ...
        baseFrame5 = new RendererModel(this, 19, 10);
        ...
        baseFrame6 = new RendererModel(this, 19, 10);
        ...
        cannon1 = new RendererModel(this, 24, 0);
        ...
        cannon2 = new RendererModel(this, 27, 3);
        ...
        cannon3 = new RendererModel(this, 27, 3);
        ...
        cannon4 = new RendererModel(this, 18, 0);
        ...
        cannon5 = new RendererModel(this, 18, 0);
...
//    }
    ...
    public void renderModel(float size, float rotationAngle, float heightAngle) {
        ...
        GlStateManager.translated(0.0, 0.0, -0.09375D);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translated(0.0D, 1.0D, -0.09375D);
        GlStateManager.rotated(heightAngle, 1.0F, 0.0F, 0.0F);
        GlStateManager.translated(0.0D, -1.0D, 0.09375D);
        cannon1.render(size);
        cannon2.render(size);
        cannon3.render(size);
