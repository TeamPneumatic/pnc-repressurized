...
public class ModelUniversalSensor extends AbstractTileModelRenderer.BaseModel {
    ...
    public ModelUniversalSensor(){
        ...
        dish4 = new RendererModel(this, 10, 50);
        ...
        dish5 = new RendererModel(this, 0, 58);
        ...
        dish6 = new RendererModel(this, 0, 60);
    ...
    public void renderModel(float scale, float dishRotation) {
        ...
        GlStateManager.rotated(dishRotation, 0, 1, 0);
        dish1.render(scale);
        dish2.render(scale);
        dish3.render(scale);
        dish4.render(scale);
