...
public class ModelLogistics extends ModelModuleBase {
    ...
    public ModelLogistics(ModuleLogistics module) {
        ...
        notPowered = new RendererModel(this, 72, 0);
        ...
        powered = new RendererModel(this, 48, 0);
        ...
        action = new RendererModel(this, 24, 0);
        ...
        notEnoughAir = new RendererModel(this, 0, 0);
