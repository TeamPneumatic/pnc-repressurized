...
public class ClientSetup {
    ...
    private static void registerProgWidgetScreenFactories() {
        ...
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.COORDINATE, ProgWidgetCoordinateScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_COORDINATE, ProgWidgetCoordinateConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.COORDINATE_OPERATOR, ProgWidgetCoordinateOperatorScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CRAFTING, ProgWidgetCraftingScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DIG, ProgWidgetDigScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DRONE_CONDITION_ITEM, ProgWidgetDroneConditionScreen.Item::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DRONE_CONDITION_UPGRADES, ProgWidgetDroneConditionScreen.Upgrades::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DRONE_CONDITION_LIQUID, ProgWidgetDroneConditionScreen.Fluid::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DRONE_CONDITION_PRESSURE, ProgWidgetDroneConditionScreen.Pressure::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DRONE_CONDITION_RF, ProgWidgetDroneConditionScreen.Energy::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.DROP_ITEM, ProgWidgetDropItemScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.EMIT_REDSTONE, ProgWidgetEmitRedstoneScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.RF_EXPORT, ProgWidgetImportExportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.RF_IMPORT, ProgWidgetImportExportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.ENTITY_ATTACK, ProgWidgetEntityAttackScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_ENTITY, ProgWidgetConditionScreen.Entity::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.ENTITY_IMPORT, ProgWidgetAreaShowScreen::minimal);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.ENTITY_RIGHT_CLICK, ProgWidgetAreaShowScreen::minimal);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.EXTERNAL_PROGRAM, ProgWidgetExternalProgramScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.FOR_EACH_COORDINATE, ProgWidgetForEachScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.FOR_EACH_ITEM, ProgWidgetForEachScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.GOTO, ProgWidgetGoToLocationScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.HARVEST, ProgWidgetHarvestScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.INVENTORY_EXPORT, ProgWidgetImportExportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.INVENTORY_IMPORT, ProgWidgetImportExportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.ITEM_ASSIGN, ProgWidgetItemAssignScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.ITEM_FILTER, ProgWidgetItemFilterScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_ITEM_INVENTORY, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_LIGHT, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.LIQUID_EXPORT, ProgWidgetLiquidExportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.LIQUID_FILTER, ProgWidgetLiquidFilterScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.LIQUID_IMPORT, ProgWidgetLiquidImportScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_LIQUID_INVENTORY, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.LOGISTICS, ProgWidgetAreaShowScreen::minimal);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.PICKUP_ITEM, ProgWidgetPickupItemScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.PLACE, ProgWidgetPlaceScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_PRESSURE, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_REDSTONE, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.CONDITION_RF, ProgWidgetConditionScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.STANDBY, ProgWidgetStandbyScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.TEXT, ProgWidgetStringScreen::new);
        ProgWidgetGuiManager.registerProgWidgetGui(ModProgWidgetTypes.COMMENT, ProgWidgetStringScreen::new);
