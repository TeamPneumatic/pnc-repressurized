...
public class EventHandlerPneumaticCraft {
    ...
    public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        event.player.sendStatusMessage(new TextComponentString(
                TextFormatting.GOLD + "PneumaticCraft is in unstable pre-release status at this time.\n" +
                TextFormatting.GOLD + "While functionally complete, bugs are likely!"), false);
    }
