...
public class ProgWidgetEntityExport extends ProgWidgetAreaItemBase {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ProgWidgetEntityExport> STREAM_CODEC = StreamCodec.composite(
            PositionFields.STREAM_CODEC, ProgWidget::getPosition,
            ProgWidgetEntityExport::new
    );
    ...
    public IProgWidget copyWidget() {
        return new ProgWidgetEntityExport(getPosition());
    }
