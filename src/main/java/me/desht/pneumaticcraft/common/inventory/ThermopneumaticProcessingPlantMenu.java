...
public class ThermopneumaticProcessingPlantMenu extends
        AbstractPneumaticCraftMenu<ThermopneumaticProcessingPlantBlockEntity> {

    public ThermopneumaticProcessingPlantMenu(int i, Inventory playerInventory, FriendlyByteBuf buffer) {
        this(i, playerInventory, getTilePos(buffer));
    }

    public ThermopneumaticProcessingPlantMenu(int windowId, Inventory playerInventory, BlockPos pos) {
        ...
        addSlot(new OutputOnlySlot(te.getOutputInventory(), 0, 53, 67));
