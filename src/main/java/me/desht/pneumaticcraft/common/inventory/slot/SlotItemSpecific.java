...
public class SlotItemSpecific extends SlotItemHandler {
    private final Predicate<ItemStack> itemAllowed;

    public SlotItemSpecific(IItemHandler handler, Predicate<ItemStack> itemAllowed, int index, int x, int y) {
