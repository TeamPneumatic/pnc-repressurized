...
public class VillagerTradesRegistration {
    ...
    public static void registerTrades(VillagerTradesEvent event) {
        ...
        if (event.getType() == ModVillagers.MECHANIC.get()) {
            ...
            trades.get(1).add(new RandomTradeBuilder(8, 4, 0.05F)
                    .setEmeraldPrice(3, 7)
            ...
            trades.get(2).add(new RandomTradeBuilder(8, 4, 0.05f)
            ...
            trades.get(3).add(new RandomTradeBuilder(1, 10, 0.05F)
            ...
            trades.get(3).add(new RandomTradeBuilder(4, 10, 0.05F)
                    .setEmeraldPriceFor(8, 16, ModItems.GUN_AMMO.get(), 1)
                    .build()
            );
            trades.get(4).add(new RandomTradeBuilder(4, 12, 0.05F)
            ...
            trades.get(4).add(new RandomTradeBuilder(6, 15, 0.05F)
