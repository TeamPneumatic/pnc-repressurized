...
public class ItemRemote extends Item {
    ...
    public ActionResultType onItemUse(ItemUseContext ctx) {
        ...
        ItemStack remote = ctx.getItem();
        if (te instanceof TileEntitySecurityStation && !world.isRemote && player.isSneaking() && isAllowedToEdit(player, remote)) {
    ...
    private void toBytes(PacketBuffer buf, PlayerEntity player, Hand hand, boolean syncGlobals) {
