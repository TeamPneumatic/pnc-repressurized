...
public class ProgWidgetConfig extends AuxConfigJson {
    ...
    public boolean isWidgetBlacklisted(ProgWidgetType<?> widgetType) {
        ResourceLocation regName = PneumaticCraftUtils.getRegistryName(PNCRegistries.PROG_WIDGETS_REGISTRY, widgetType).orElseThrow();
    ...
    protected void writeToJson(JsonObject json) {
        ...
        for (ResourceLocation entry : PNCRegistries.PROG_WIDGETS_REGISTRY.keySet()) {
