...
public class BlockThermopneumaticProcessingPlant extends BlockPneumaticCraft {
    private static final VoxelShape TANK_IN1 = Block.makeCuboidShape(0, 0, 9, 7, 12, 16);
    private static final VoxelShape TANK_IN2 = Block.makeCuboidShape(9, 0, 9, 16, 12, 16);
    private static final VoxelShape TANK_OUT = Block.makeCuboidShape(5, 0, 0, 11, 8, 6);
