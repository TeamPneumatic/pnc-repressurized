...
public class PressureChamberGlassBlockEntity extends PressureChamberWallBlockEntity {
    ...
    public PressureChamberGlassBlockEntity(BlockPos pos, BlockState state) {
