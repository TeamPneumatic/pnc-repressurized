...
public class BlockRefineryOutput extends BlockPneumaticCraft {
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.makeCuboidShape(13, 11, 14.5, 14.5, 12, 15.5),
            Block.makeCuboidShape(12, 1, 14, 13, 13, 16),
            Block.makeCuboidShape(3, 1, 14, 4, 13, 16),
            Block.makeCuboidShape(1.5, 11, 14.5, 3, 12, 15.5),
            ...
            Block.makeCuboidShape(4, 1, 13, 12, 14, 16),
            ...
            Block.makeCuboidShape(0.5, 11, 1.5, 1.5, 12, 14.5),
            ...
            Block.makeCuboidShape(13.25, 7.5, 9.25, 14.25, 9.5, 11.25),
            Block.makeCuboidShape(13.25, 7.5, 6.75, 14.25, 9.5, 8.75),
            Block.makeCuboidShape(0, 13, 3, 2, 16, 6),
            Block.makeCuboidShape(0, 3.5, 3, 2, 5.5, 6),
            Block.makeCuboidShape(13.5, 8, 7.25, 15.5, 9, 8.25),
            Block.makeCuboidShape(13.5, 8, 9.75, 15.5, 9, 10.75),
            Block.makeCuboidShape(14.5, 1, 7.25, 15.5, 8, 8.25),
            Block.makeCuboidShape(14.5, 1, 9.75, 15.5, 8, 10.75),
            Block.makeCuboidShape(0.5, 1, 3.5, 2.5, 4, 5.5),
            Block.makeCuboidShape(14.5, 11, 1.5, 15.5, 12, 14.5)
