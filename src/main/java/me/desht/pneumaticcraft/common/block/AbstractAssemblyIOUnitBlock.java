...
public abstract class AbstractAssemblyIOUnitBlock extends AbstractPneumaticCraftBlock implements PneumaticCraftEntityBlock {
    ...
    public AbstractAssemblyIOUnitBlock(Properties props) {
        super(props);
    }
    ...
    public static class Export extends AbstractAssemblyIOUnitBlock {
