        ...
        ctx.get().enqueueWork(() -> {
            ...
            if (player == null) {
                ...
                if (entity != null) {
                    ...
                    NetworkHandler.sendToAllAround(this, new PacketDistributor.TargetPoint(entity.getPosX(), entity.getPosY(), entity.getPosZ(), 64, entity.world.getDimension().getType()));
                }
            }
        });
