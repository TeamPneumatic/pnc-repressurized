...
import static me.desht.pneumaticcraft.common.recipes.special.ShapedFluidCraftingRecipe.SpeedUpgradeCrafting;
...
public class ModRecipes {
    ...
    public static final SpecialRecipeSerializer<SpeedUpgradeCrafting> SPEED_UPGRADE_CRAFTING = null;
    ...
    public static class Registration {
        ...
        public static void registerRecipes(final RegistryEvent.Register<IRecipeSerializer<?>> event) {
            ...
            event.getRegistry().register(new SpecialRecipeSerializer<>(SpeedUpgradeCrafting::new).setRegistryName(RL("speed_upgrade_crafting")));
