...
public interface IBaseSensor {
     ...
     */
    default List<String> getTextBoxOptions(PlayerEntity player) {
        return null;
    }

    /**
     * If {@link #getTextBoxOptions(PlayerEntity)} returns a non-null result, this can be used to control if the
