...
/**
 * Fired just before the finalised puzzle piece list is called.  If you need to register custom puzzle pieces, do it
 * here, via {@link PuzzleRegistryEvent#getDroneRegistry()} and {@link IDroneRegistry#registerCustomBlockInteractor(ICustomBlockInteract)}
 */
